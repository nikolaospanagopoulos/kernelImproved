...
./build/kernel.o: ./src/kernel.cpp
	i686-elf-gcc $(INCLUDES) $(FLAGS) -c ./src/kernel.cpp -o ./build/kernel.o

./build/string/string.o: ./src/String.cpp
	i686-elf-gcc $(INCLUDES) $(FLAGS) -c ./src/String.cpp -o ./build/string/string.o
clean:
	rm -rf ./bin/boot.bin
